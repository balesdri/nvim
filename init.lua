...
--x |                                           ,:___  | x |
--x | -_____                                   /  __ \_| x |
--x |_/ __  "--..___'_              _  _____.-`  /  \
--     /  \   _ ___////   ENVRNMT   \( \_____    \__/ _
--   _ \__/ _                               ""+.   __/ | x |
--x | \__ _/                                    '. 7 , | x |
...
if is_vscode then
    ...
    -- [F]ile Management (GET TELESCOPE)
        --  Open file 
    --vim.api.nvim_set_keymap('n', '<leader><leader>', ':find', { noremap = true, silent = true })
        --  f - Search all files in project
    vim.api.nvim_set_keymap('n', '<leader>ff', ':vimgrep /', { noremap = true, silent = true })
    ...
    vim.api.nvim_set_keymap('n', '<leader>w|', '<C-w>v', { noremap = true, silent = true })
        -- q - Close window
    vim.api.nvim_set_keymap('n', '<leader>wq', '<C-w>c', { noremap = true, silent = true })
    ...
    vim.api.nvim_set_keymap('n', '<leader>tl', '<cmd>tabnext<cr>', { noremap = true, silent = true })
        -- h - Previous tab
    vim.api.nvim_set_keymap('n', '<leader>th', '<cmd>tabprevious<cr>', { noremap = true, silent = true })
        -- q - Close tab
